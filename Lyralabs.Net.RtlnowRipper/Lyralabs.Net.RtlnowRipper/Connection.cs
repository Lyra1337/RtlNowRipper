...
namespace Lyralabs.Net.RtlnowRipper
{
  public class Connection
  {
    ...
    {
      string host = "localhost"; //ConfigurationManager.AppSettings["dbhost"];
      string user = "instantview"; //ConfigurationManager.AppSettings["dbuser"];
      string pass = "QzUHTzDydFxN4MyY"; //ConfigurationManager.AppSettings["dbpass"];
      string name = "instantview"; //ConfigurationManager.AppSettings["dbname"];
